from account.adapters import data_models
from account.domain import entities
# from backbone.adapters.abstract_data_model import MAPPER_REGISTRY
# from sqlalchemy.orm import mapper
def start_mappers():
    pass
    # MAPPER_REGISTRY.map_imperatively(entities.UserEntity, data_models.user_data_model)
    # MAPPER_REGISTRY.map_imperatively(entities.UserDetailEntity, data_models.user_detail_data_model)
    # MAPPER_REGISTRY.map_imperatively(entities.VerifyUserEntity, data_models.verify_user_data_model)
